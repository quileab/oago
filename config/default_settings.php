...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Master registry of system settings required by the application.
    | These entries are used by `php artisan app:sync-settings` and seeders
    | to ensure missing parameters are provisioned into the database without
    | overriding existing customized values.
    |
    */
    ...
    'alt_user_default_price' => [
        'value' => 2,
        'type' => 'number',
        'text' => 'Lista de Precios Invitados',
        'description' => 'ID de lista de precios asignada por defecto a usuarios de cortesía.',
    ],
    ...
    'order_placed_mail' => [
        'value' => null,
        'type' => 'string',
        'text' => 'Email Notificación de Pedidos',
        'description' => 'Correo que recibe copia de los pedidos realizados.',
    ],
    ...
    'product_tags' => [
        'value' => json_encode(['NUEVO', 'OFERTA', 'REMATE', 'IMPORTADOS', 'DESTACADO', 'LIQUIDACION', 'ULTIMAS_UNIDADES']),
        'type' => 'json',
    ...
    'image_proxy_allowed_hosts' => [
        'value' => json_encode([]),
        'type' => 'json',
        'text' => 'Hosts Permitidos Proxy Imágenes',
        'description' => 'Lista blanca de hosts permitidos para el proxy de imágenes.',
    ],
