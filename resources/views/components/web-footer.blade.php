<footer class="w-full bg-slate-900 text-slate-300 pt-10 pb-6 mt-12 border-t-4 border-orange-500">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div class="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div class="mt-8">
                <span class="px-3 py-1 bg-green-900/30 text-green-400 text-[10px] font-black rounded-full border border-green-800 uppercase tracking-widest">
                    Sistema Online 24/7
                </span>
            </div>
        </div>
    ...
    <!-- Barra Inferior -->
    <div class="max-w-7xl mx-auto px-6 mt-12 pt-6 border-t border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-[11px] text-slate-500 font-bold uppercase tracking-tighter">
            {{ App\Helpers\SettingsHelper::settings('copyright', '© O.A. Distribuciones - 2026') }}
        </p>
        <p class="text-[10px] text-slate-600 flex items-center gap-1 font-medium italic">
            Desarrollado con <x-icon name="s-heart" class="w-3 h-3 text-red-700" /> por Quileab
        </p>
    </div>
