...
<body class="antialiased overflow-hidden">
    ...
    <div class="fixed inset-0 -z-20 opacity-60">
        <div class="w-full h-full bg-cover bg-center blur-3xl" 
             style="background-image: url('{{ asset('imgs/rsrc/403_bg.png') }}');">
        </div>
    </div>
        ...
        <div class="flex justify-center w-full">
            <div class="max-w-xl w-full bg-base-100/60 backdrop-blur-xl p-4 md:p-6 rounded-3xl shadow-2xl border border-white/10 text-center">
                <div class="relative inline-block mb-1">
                    <h1 class="text-6xl font-black text-warning/40 select-none">403</h1>
                </div>
                <h2 class="text-2xl font-black uppercase tracking-tighter mb-1 text-white drop-shadow-md">Acceso Denegado</h2>
                <p class="text-white/90 font-bold drop-shadow-sm text-sm">No tienes los permisos necesarios para acceder a esta sección.</p>
            </div>
        </div>
