...
<div class="mx-5 z-10">
    @if($featured)
        <h2 class="text-xl font-black text-neutral-100 my-8 flex items-center gap-3">
    ...
    @endif
    <div wire:ignore.self class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
