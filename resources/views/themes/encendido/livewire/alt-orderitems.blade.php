...
<div>
    ...
    <div class="print-only print-header mb-8">
        <div class="flex justify-between items-start">
            <div>
                <img src="{{ asset('imgs/Logos/isoER50.png') }}" class="w-32 mb-2" alt="Encendido Reconquista SRL">
                <p class="text-xs font-bold uppercase tracking-widest text-neutral-500">Comprobante de Pedido Externo</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 items-start no-print">
        ...
        <div class="p-4 rounded-xl border border-base-300">
            <h3 class="font-bold uppercase text-xs text-neutral-500 mb-2">Estado y Gestión</h3>
    ...
    <x-card shadow class="mb-6">
        <table class="table w-full">
            <thead class="uppercase text-[10px] font-black tracking-widest text-neutral-500">
                <tr>
                    <th class="w-20">ID</th>
                    <th>Producto</th>
    ...
    @if($order->shipping)
        <x-card title="Información de Entrega (Logística)" icon="o-truck" shadow separator class="mt-6 border-l-4 border-primary no-print">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <p class="text-xs font-black uppercase text-neutral-500 mb-1">Dirección de Envío</p>
                ...
                <div>
                    <p class="text-xs font-black uppercase text-neutral-500 mb-1">Contacto de Entrega</p>
                    <p class="font-bold">{{ $order->shipping->phone ?? 'No especificado' }}</p>
                </div>
                <div>
                    <p class="text-xs font-black uppercase text-neutral-500 mb-1">Estado del Envío</p>
