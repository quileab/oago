...
new #[Layout('components.layouts.clean')] #[Title('Registrarse - Agostini Distribuidor')] class extends Component {
    use Toast;
...
<div data-theme="light" class="bg-white min-h-screen text-gray-900 antialiased">
    ...
    <div class="relative h-64 md:h-96 overflow-hidden flex items-center justify-center bg-gray-900">
        <img src="{{ asset('imgs/brand.webp') }}" class="absolute inset-0 w-full h-full object-cover opacity-40 blur-xs" alt="Regístrate">
        <div class="absolute inset-0 bg-linear-to-t from-gray-900/80 to-transparent"></div>
        <div class="relative text-center px-4">
            <x-header title="Regístrate" size="text-4xl md:text-6xl" class="!text-white font-black drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
                <x-slot:subtitle>
                    <div class="!text-white font-bold opacity-100 drop-shadow-md">
