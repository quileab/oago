    ...
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between gap-4">
            <div class="flex justify-between flex-1 sm:hidden">
                ...
                <div class="flex items-center text-sm text-gray-700 dark:text-gray-400 font-medium">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                        <span class="font-medium">{{ $paginator->firstItem() }}-{{ $paginator->lastItem() }} / {{ $paginator->total() }}</span>
                    </p>
                </div>
